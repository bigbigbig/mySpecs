#
# Be sure to run `pod lib lint bgsdk.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://gitee.com/zhangmingsheng_1992/bgsdk_ios'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mingsheng Zhang' => '1046724509@qq.com' }
  s.source           = { :git => 'https://gitee.com/zhangmingsheng_1992/bgsdk_ios.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.platform = :ios, '15.0'
  s.ios.deployment_target = '15.0'

  s.source_files = 'bgsdk_ios/Classes/**/*{h,m}'
  s.resource_bundles = {
     'bundle' => ['bgsdk_ios/Assets/*']
  }
  
#  s.static_framework = true
#   s.header_mappings_dir = '.'
  s.public_header_files = 'bgsdk_ios/Classes/**/*.h'
  s.vendored_frameworks = 'bgsdk_ios/Frameworks/BGSDKIOSFramework.framework'
